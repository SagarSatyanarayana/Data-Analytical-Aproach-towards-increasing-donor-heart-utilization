...
drop table if exists tsam2011tx_relaxed_valid_status_window;
create table tsam2011tx_relaxed_valid_status_window as 
	(
...
drop table if exists tsam2011tx_relaxed_last_tier_status;
create table tsam2011tx_relaxed_last_tier_status as 
	(
